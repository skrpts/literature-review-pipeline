...
description: "Drafts a complete literature review from synthesized research findings"
...
3. **Thematic sections** — organize the review by theme, not by paper. Each section should:
   - State the theme and its relevance to the research question
   - Synthesize findings from multiple papers (do not summarize papers one by one)
   - Note areas of agreement and disagreement
   - Assess the quality of evidence
4. **Discussion** — what does the literature collectively tell us? What are the gaps?
5. **Conclusion** — summarize key findings and suggest directions for future research
